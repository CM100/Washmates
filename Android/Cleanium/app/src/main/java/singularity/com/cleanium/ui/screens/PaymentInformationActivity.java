...
public class PaymentInformationActivity extends AppCompatActivity implements ProfileView {
    ...
    public void showUserDetails(User user) {
        startPaymentFragment(user);
    }

    void startPaymentFragment(User user) {
        ...
        Utils.openFragment(this, R.id.paymentInfoContainer, signUpPaymentFragment, SignUpPaymentFragment.TAG);
    }
