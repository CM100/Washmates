...
-(void)setUp{
    self.view = [[[NSBundle mainBundle] loadNibNamed:@"Tutorial2View" owner:self options:nil] lastObject];
    ...
    NSString *stringTojustify                = @"A wash mate will arive at your door at the chosen time. If this is your first time, they will provide the laundry bags - one for dry cleaning and shirts to be ironed, and another for everything else. Place your clothes in these bags and hand back to your wash mate. ";
